...
description: "Build accessible design systems with Radix UI primitives. Use when creating UI components (Dialog, Dropdown, Tabs, forms built on Radix primitives, etc.). Headless component customization, theming strategies, compound component patterns, and accessibility (ARIA, keyboard, focus, WCAG). Other skills defer component a11y to this skill."
risk: safe
source: self
...
- **Creating or customizing UI components** (explicit default for new component work)
...
Other skills defer **component-level** accessibility (ARIA, keyboard, focus, screen readers) to the **Accessibility First** and checklist sections in this skill — not a separate a11y skill.
...
- `react-hook-form-zod` - Form schemas and validation (form-field labels/errors stay there; Radix primitives for selects/dialogs stay here)
