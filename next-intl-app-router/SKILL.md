...
description: Configures and uses next-intl for Next.js App Router with locale-based routing. Use when adding or changing i18n setup — locale routing, next-intl plugin, middleware/proxy, message files, useTranslations, dates/numbers/plurals, and language-switcher UX. Defer hreflang, localised metadata, localised sitemaps, and crawl/index SEO to nextjs-seo. Defer copy translation quality to translation-guidelines.
---
...
| This skill | Defer to |
|------------|----------|
| Routing, plugin, middleware/proxy, messages, formatting, language switcher | — |
| hreflang, `alternates.languages`, localised metadata/OG/JSON-LD, localised sitemap | `nextjs-seo` |
| Copy translation quality, tone, locale-specific wording | `translation-guidelines` |
| Missing translation keys, locale fallbacks, URL/state desync bugs | `edge-cases` |
